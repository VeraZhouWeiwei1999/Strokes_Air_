...
# Rename
df_air = utils.get_data(setting.base_path + "joined_data.csv")
# df_air = get_data("./data for project/Air_data/joined_dat.csv")

# select 2013, 2014, 2016
def select_dates(dates):
    df_dates = pd.DataFrame(
        columns=[Colums.DATE, 'AQI', 'Category', 'Defining Parameter', 'city_ascii', 'state_id', 'population'])
...
utils.save_data(air_mean_per_year_df, "combined", "air_mean_per_year")
